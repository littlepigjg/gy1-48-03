...
export const WEATHER_CONFIG = {
  sandstorm: {
    ...
    baseChance: 0.004,
    surfacePeakDepth: 20,
    chanceDecayRate: 0.035,
    maxWeatherDepth: 120,
    visualDecayRate: 0.045,
    warningTime: 8,
    minDuration: 25,
    maxDuration: 45,
    speedReduction: 0.4,
    ...
    specialOreExposureCheckDist: 12
  },
  acid_rain: {
    name: '酸雨',
    icon: '☣️',
    ...
    baseChance: 0.003,
    surfacePeakDepth: 25,
    chanceDecayRate: 0.03,
    maxWeatherDepth: 150,
    visualDecayRate: 0.04,
    warningTime: 10,
    minDuration: 20,
    maxDuration: 35,
    speedReduction: 0,
    ...
    damagePerSecond: 3,
    specialOreMaxDepth: 60,
    specialOreMinSurfaceDist: 8,
    specialOreExposureCheckDist: 15
  }
};
